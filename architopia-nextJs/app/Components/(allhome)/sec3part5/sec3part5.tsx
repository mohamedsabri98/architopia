...
import style from './sec3part5.module.scss'
    ...
    <div className="col-md-12">
             ...
             <div className={`d-flex  align-items-center ${style.listImg}`}>
               ...
               <div className={`${style.t} cursor-pointer position-relative`}>
                   ...
                   <div data-bs-toggle="modal" data-bs-target="#staticBackdropsec3part5" className={style.sliderphoto}>
                       <h4 className='text-white '>+12</h4>
                   </div>
                   <div className="modal fade" id="staticBackdropsec3part5" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div className="modal-dialog">
                            <div className="modal-content">
                            <div className="modal-header">
                                <h1 className="modal-title fs-5" id="staticBackdropLabel">sec3 part5</h1>
