...
import style from './sec2part1.module.scss'
    ...
    <div className="col-md-8">
             ...
             <div className={`d-flex  align-items-center ${style.listImg}`}>
               ...
               <div className={`${style.t} cursor-pointer position-relative`}>
                   ...
                   <div data-bs-toggle="modal" data-bs-target="#staticBackdropsec2part1" className={style.sliderphoto}>
                       <h4 className='text-white '>+12</h4>
                   </div>
                   <div className="modal fade" id="staticBackdropsec2part1" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="staticBackdropLabel" aria-hidden="true">
             ...
             <div className={`${style.captionAll1} w-50 me-2`}>
                 ...
                 <div className=" mb-2 d-flex ">
                   <Image src={img12} alt='logo'/>
                     ...
                     <span className='ms-2 bold text-main cursor-pointer'>2340 m²</span>
                 </div>
                 <div className=" mb-2 d-flex">
                 <Image src={img13} alt='logo'/>

                     <p className='ms-2 bold text-darkk'>Year:</p>
                     <span className='ms-2 bold text-main cursor-pointer'>2023</span>
                 </div>
             </div>
           ...
           <Image src={img17} alt='logo'/>
             ...
             <span className='ms-2 bold text-main cursor-pointer'>Saint Gobian, GLC, frist Marble, ever green</span>
           </div>
           ...
           <h5 className={style.RoofingSolutions}><Link className={style.linkcaption} href='#'>Roofing Solutions</Link> </h5>
           <div className="div mb-3 text-darkk ">
