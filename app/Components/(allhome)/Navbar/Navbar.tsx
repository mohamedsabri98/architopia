...
function Navbar() {
    return (
        <>
            <div
                className={`${style.upNavbar} d-flex align-items-center justify-content-center`}
            >
                ...
                <div
                    className={`${style.allbtnn} d-flex align-items-center justify-content-center`}
                >
            ...
            <div className={style.edittest}>
                <nav
                    className={`navbar navbar-expand-lg m-auto ${style.nabarr}`}
                >
                    <div className="container-fluid">
                        ...
                        >
                            <ul className="navbar-nav m-auto d-flex alighn-items-center justify-content-center mb-lg-0">
                                ...
                                <li
                                    className={`nav-item   ${style.navHomeout}`}
                                >
