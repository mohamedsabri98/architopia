...
function SingleProject() {
  return (
    ...
    <div className={style.pathlink}>
      <span className={style.pathlinkcolor}>Architupia <Image src={img1} alt='logo'/></span> 
      <span className={style.pathlinkcolor}>Projects <Image src={img1} alt='logo'/> </span>
      <span className={style.pathlinkcolor}>Airport <Image src={img1} alt='logo'/> </span>
      <span className={style.pathlinkcolor}>Cairo International Airport TB2 </span><Image src={img1} alt='logo'/>
      <span> ECG</span>
    </div>
